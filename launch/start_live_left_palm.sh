...
python3 scripts/prepare_urdf_for_rviz.py \
  ...
  --out-dir generated >/tmp/rh56_left_rviz_urdf_paths.txt
PARAM_FILE="$(tail -n 1 /tmp/rh56_left_rviz_urdf_paths.txt)"
URDF_FILE="$(head -n 1 /tmp/rh56_left_rviz_urdf_paths.txt)"
